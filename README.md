...
[![Deploy to GitHub Pages](https://github.com/Marcosh1515/SSDP0039-A02/actions/workflows/deploy.yml/badge.svg)](https://github.com/Marcosh1515/SSDP0039-A02/actions/workflows/deploy.yml)
...
2. Update your local repository
   ...
   ```bash
   git remote set-url origin https://github.com/Marcosh1515/SSDP3900-A02.git
   ```
...
1. Replace the `USERNAME` in the badge URL with your GitHub username:
   ```markdown
   [![Deploy to GitHub Pages](https://github.com/Marocsh1515/SSDP3900-A02/actions/workflows/deploy.yml/badge.svg)](https://github.com/Marcosh1515/SSDP3900-A02/actions/workflows/deploy.yml)
   ```
